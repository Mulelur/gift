...
import img from "../../assets/gitf.jpeg";
import { AboutMe } from "../../components";
import { DownloadCVButton } from "../../components/buttons";
import cv from "../../assets/cv/GIFT VHAFUNAHO SIAVHE.pdf";
import letter from "../../assets/cv/gift_letter.pdf";
    ...
    <AboutMe>
      <AboutMe.Container>
        ...
        <AboutMe.Column>
          ...
          <AboutMe.Heading4>
            Hello! My Name is Gift Vhafunaho Siavhe.
          </AboutMe.Heading4>
          <AboutMe.Text>
